...
def fix_reverse_links(session, name_forwards, name_reverse):
    ...
    """
    dict_forwards = halo_db.core.dictionary.get_or_create_dictionary_item(db.core.internal_session, name_forwards)
    dict_reverse = halo_db.core.dictionary.get_or_create_dictionary_item(db.core.internal_session, name_reverse)
